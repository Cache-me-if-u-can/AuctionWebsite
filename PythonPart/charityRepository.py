...
class CharityRepository:
    ...
    def getListOfCharities(self):               
        ...
        for charity in all_charities:               
            ...
            web_charity = Charity(_id, name, email,phoneNum, password, imageFile, address)    
    ...
    def createCharity(self, charity):                             
        if(self.charityExist(charity.email)==False):
            new_charity={ "name":charity.name, "email":charity.email,"phoneNum":charity.phoneNum, "password": charity.password, "imageFile":charity.imageFile, "address":charity.address}

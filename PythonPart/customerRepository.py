...
class CustomerRepository:
    ...
    def getListOfCustomers(self):               
        ...
        for customer in all_customers:               
            ...
            web_customer = Customer(_id, name, surname, dateOfBirth, email,phoneNum, password, imageFile, address)    
    ...
    def createCustomer(self, customer):                             
        if(self.customerExist(customer.email)==False):
            new_customer={ "name":customer.name, "surname":customer.surname, "dateOfBirth": customer.dateOfBirth, "email":customer.email,"phoneNum":customer.phoneNum, "password": customer.password, "imageFile":customer.imageFile, "address":customer.address}
